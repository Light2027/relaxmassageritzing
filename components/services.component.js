...
import {GetServiceContent, GetServicesContent} from "../services/content.service";
...
export default function ServicesComponent() {
  ...
  return <div id="services" className="border-bottom d-flex flex-column justify-content-center">
    ...
    <div className="border border-2 border-secondary bg-white col-10 col-md-6 col-lg-4 col-xl-3 align-self-center rounded mt-3 mb-5 p-3">
      {services.map((s) => (
